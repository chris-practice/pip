          <div><?php print t('Dear ') . $items['rep_name'] . t(','); ?></div>
<div>&nbsp;</div>
<div><?php print t('RR Donnelly will issue the AF Screening pack to your PO Box/delivery address in the next 48 hours. AliveCor device '); ?>

	<strong><?php print $items['deviceid']; ?></strong><?php print t(' is now assigned to '); ?><?php print $items['title'] .' '. $items['name']. ' ' . $items['surname']; ?></div>
 
<div><?php print t('The AliveCor Device will need to be returned by you to the warehouse at the end of the 3 month loan period.'); ?></div>

<div><?php print t('The Letter of Offer detailing the loan details is attached for your reference. Please supply the attached Letter of Offer with the AliveCor device to your HCP when you deliver. Your HCP is required to sign 
the document acknowledging receipt of the device that is on loan to them. '); ?></div>
<div>&nbsp;</div>
<div><?php print t('Note: when you deliver the device please go to the Device Tab and tick the ');?><strong><?php print t('Delivered Confirmed ');?></strong><?php print t('under the Device Tab on the Thrombo 360 Education website.'); ?></div>
