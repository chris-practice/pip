...
<div>&nbsp;</div>
<div><?php print t('The attached Letter of Offer is to be printed and packed with the Screening Pack containing the AliveCor device. The weekly report with full order details will be supplied on Wednesday.'); ?></div>
<div>&nbsp;</div>
<div><?php print t('Please contact Kimberley Henderson at <a href="mailto:kimberley.henderson@pfizer.com">kimberley.henderson@pfizer.com</a> if you have any questions.'); ?></div>
<div>&nbsp;</div>
