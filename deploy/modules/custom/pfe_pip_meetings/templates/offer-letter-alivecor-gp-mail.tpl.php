...
<div>&nbsp;</div>
<div><?php print t('Thank you for your interest in the AlivecCor loan program.'); ?></div>
...
} print t(', will be in touch with you shortly in regards to delivery of the device.'); ?></div>
<div>&nbsp;</div>
