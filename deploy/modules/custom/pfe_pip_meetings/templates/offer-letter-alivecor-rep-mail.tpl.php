...
<div>&nbsp;</div>
<div><?php print t('RR Donnelly will issue the AF Screening pack to your PO Box/delivery address in the next 48 hours. Contained in the screening pack assigned to '); ?><?php print $items['title'] .' '. $items['name']. ' ' . $items['surname']; ?><?php print t(' is an AliveCor Device '); ?><strong><?php print $items['deviceid']; ?></strong></div>
 <div>&nbsp;</div>
<div><?php print t('The AliveCor Device will need to be returned by you to the warehouse at the end of the 6 week pilot period.'); ?></div>
<div>&nbsp;</div>
<div><?php print t('The Letter of Offer detailing the loan details is attached for your reference. Please supply the attached Letter of Offer with the AliveCor device to your HCP when you deliver. Your HCP is required to sign the document acknowledging receipt of the device that is on loan to them.'); ?></div>
<div>&nbsp;</div>
<div><?php print t('Note: when you deliver the device please mark this on the Thrombo 360 website'); ?></div>
<div>&nbsp;</div>
